...
public class StartTabComposite extends org.cognetics.proverspalette.base.gui.StartTabComposite {
	...
	protected void makeProverTidyingButtons(Composite buttons) {
		...
		buttonExpandPredicates.setToolTipText("The goal contains predicates which will not be understood by QEPCAD. " +
...
//					  insertCommand("expand", true);
	...
	//TODO - warning if no algebraic part in subgoal. do not take user to any other tab.
	
	//TabUpdateManager newProblem = new TabUpdateManager(view);
	//newProblem.updateWithNewProblem(c);
